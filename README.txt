...
The app tries to parse the card data as per the standards published in 2002. 
It is primarely targeting enthusiasts who wants to know more about their cards 
but should also be easy to use and useful for travellers wanting to see their 
...
A list of devices that are known to be problematic, please see the file
COMPATIBILITY.txt which should be present at the same place as this file.
...
The standards implemented by this application is owned by Resekortsföreningen 
i Norden.
...
https://github.com/norenh/RKFRead/issues
